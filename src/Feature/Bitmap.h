...
struct BitmapColor 
{
    ...
    explicit BitmapColor(T gray) : r(gray), g(gray), b(gray)
    {

    }
    BitmapColor(T r, T g, T b) : r(r), g(g), b(b)
    {
    ...
    {
        BitmapColor<D> color;
        color.r = BitmapColorCast<T, D>(r);
        color.g = BitmapColorCast<T, D>(g);
        color.b = BitmapColorCast<T, D>(b);
        return color;
    }
