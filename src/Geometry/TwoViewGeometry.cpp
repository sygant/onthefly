...
#include "../Estimator/FundamentalMatrix.h"
#include "../Estimator/HomographyMatrix.h"
#include "../Estimator/TranslationTransform.h"
...
TwoViewGeometry EstimateMultipleTwoViewGeometries(
    ...
    while (true) {
        TwoViewGeometry geometry = EstimateTwoViewGeometry_Internal(
