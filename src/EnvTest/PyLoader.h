...
public:
	...
	PyObject* GlobalExtractInstance;
	PyObject* DeepImageMatchingInstance;

	PyObject* GlobalExtractorFunc;
	PyObject* LocalExtractorFunc;
	PyObject* LocalFeatureSaveFunc;
	PyObject* LocalFeatureReadFunc;
	PyObject* LocalMatcherFunc;
};